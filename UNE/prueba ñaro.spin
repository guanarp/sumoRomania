...
if (ina[4]==0)        'esperamos por el sensor izq de lineas 1 es negro
      repeat 10
              PULSOUT(5,720) 'Motor derecha  ver
              PULSOUT(6,780) 'Motor izquierda  ver
              pause(20)
              if ina[17]==1
                 quit 
      repeat 11
          PULSOUT(5,710) 'Motor derecha     ver
          PULSOUT(6,710) 'Motor izquierda   ver
          pause(20)
          if ina[17]==1
              quit 
      ...
      pause(20) 
       ...
       if ( ina[5]==0)        'esperamos por el sensor der de lineas 1 es negro
          repeat 10
            PULSOUT(5,720) 'Motor derecha  verif
            PULSOUT(6,780) 'Motor izquierda  verif
            pause(20)
            if ina[17]==1
               quit 
          repeat 11
             PULSOUT(5,790) 'Motor derecha     ver
             PULSOUT(6,790) 'Motor izquierda   ver
             pause(20)
            if ina[17]==1
               quit 
          PULSOUT(5,750) 'Motor derecha  ver
          ...
          pause(20) 
              ...
              PULSOUT(5,809) 'Motor derecha     ver
              PULSOUT(6,690) 'Motor izquierda   ver
              pause(20)
