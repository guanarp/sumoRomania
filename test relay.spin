...
repeat
  if (ina[17]==1)        'esperamos por el control
...
pub adelante
if (ina[0]==0 and ina[1]==0)        'esperamos por el sensor de lineas 1 es negro
    repeat 20
          PULSOUT(5,900) 'Motor izquierda
          PULSOUT(6,600) 'Motor derecha
          
        'pause(20)
else
  
          PULSOUT(5,600) 'Motor izquierda
          PULSOUT(6,900) 'Motor derecha
